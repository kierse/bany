...
import com.pissiphany.bany.adapter.config.BanyPluginConfiguration
...
internal class FileBasedConfigurationRepositoryTest {
    ...
    fun getBudgetAccountIds() {
        ...
        val plugins = mapOf(
            "type1" to BanyPluginConfiguration("username1", "password1", listOf(BanyConnection("name1", "ynabBudgetId1", "ynabAccountId1", "accountId1"))),
            "type2" to BanyPluginConfiguration("username2", "password2", listOf(BanyConnection("name2", "ynabBudgetId2", "ynabAccountId2", "accountId2")))
        )
