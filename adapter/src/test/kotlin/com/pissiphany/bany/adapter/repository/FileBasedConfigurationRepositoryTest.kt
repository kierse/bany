...
import com.pissiphany.bany.adapter.config.Plugin
...
internal class FileBasedConfigurationRepositoryTest {
    ...
    fun getBudgetAccountIds() {
        ...
        val plugins = listOf(
            Plugin("type1", "username1", "password1", listOf(Connection("name1", "ynabBudgetId1", "ynabAccountId1", "accountId1"))),
            Plugin("type2", "username2", "password2", listOf(Connection("name2", "ynabBudgetId2", "ynabAccountId2", "accountId2")))
        )
