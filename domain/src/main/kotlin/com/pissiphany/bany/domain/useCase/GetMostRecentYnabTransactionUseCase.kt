...
class GetMostRecentYnabTransactionUseCase(private val ynabGateway: YnabMostRecentTransactionGateway) {
    fun getMostRecentTransaction(budget: Budget, account: Account): Transaction? {
        ...
        return ynabGateway.getTransactions(budget, account).firstOrNull()
    }
}